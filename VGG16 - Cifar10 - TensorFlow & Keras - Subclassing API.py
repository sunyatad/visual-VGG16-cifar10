# VGG16 Pretrained Model- Cifar10 Data - TensorFlow & Keras Framework- Subclassing API
...
# Define the new model using subclassing
...
# model summary
model.build((None, 32, 32, 3))  # Specify input shape to build the model
model.summary()
